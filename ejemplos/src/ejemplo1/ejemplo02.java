...
public class ejemplo02 {
	...
	public static void main(String args[]) { 
		...
		// En los siguientes casos se produce una conversi�n autom�tica a decimal:
		...
		System.out.println("'A'" + 1); // no sumo ahora, sino que concateno una cadena con un numero
		...
		DecimalFormat df = new DecimalFormat("0.00");	// Si necesita mas de un entero lo visualiza	
